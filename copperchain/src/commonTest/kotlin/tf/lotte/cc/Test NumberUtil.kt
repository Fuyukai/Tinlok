...
public class `Test_NumberUtil` {
    ...
    @Test
    public fun `Test_Int_toByteArray`() {
        val i = 0x0f_12_34_56
    ...
    @Test
    public fun `Test_ByteArray_toInt`() {
        val i = INT_TEST.toInt()
        assertEquals(0x0f_12_34_56, i)
    }

    @Test
    public fun `Test_Long_toByteArray`() {
    ...
    @Test
    public fun `Test_ByteArray_toLong`() {
