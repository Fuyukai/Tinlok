...
public object StandardSocketOptions {
    ...
    public val SO_DEBUG: BsdSocketOption<Boolean> =
        BooleanSocketOption(
            bsdOptionValue = tf.veriny.tinlok.net.socket.SO_DEBUG,
            level = SOL_SOCKET,
            name = "SO_DEBUG"
        )
    ...
    public val SO_REUSEADDR: BsdSocketOption<Boolean> =
        BooleanSocketOption(
            bsdOptionValue = tf.veriny.tinlok.net.socket.SO_REUSEADDR,
            level = SOL_SOCKET,
            name = "SO_REUSEADDR"
        )
    ...
    public val SO_KEEPALIVE: BsdSocketOption<Boolean> =
        BooleanSocketOption(
            bsdOptionValue = tf.veriny.tinlok.net.socket.SO_KEEPALIVE,
            level = SOL_SOCKET,
            name = "SO_KEEPALIVE"
        )
    ...
    public val SO_BROADCAST: BsdSocketOption<Boolean> =
        BooleanSocketOption(
            bsdOptionValue = tf.veriny.tinlok.net.socket.SO_BROADCAST,
            level = SOL_SOCKET,
            name = "SO_BROADCAST"
        )
    ...
    public val SO_OOBINLINE: BsdSocketOption<Boolean> =
        BooleanSocketOption(
            bsdOptionValue = tf.veriny.tinlok.net.socket.SO_OOBINLINE,
            level = SOL_SOCKET,
            name = "SO_OOBINLINE"
        )
